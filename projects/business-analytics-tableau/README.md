...
- Cleaned and reshaped Global Findex data for Tableau analysis.
...
These findings are descriptive and should be interpreted as exploratory business analysis rather than causal estimates.
...
![Story overview](screenshots/01_story_overview.png)

### Mobile money boom

![Mobile money boom](screenshots/02_mobile_money_boom.png)

### Leapfrogging traditional banking

![Leapfrogging](screenshots/03_leapfrogging.png)

### Catch-up and digital payments

![Catch-up](screenshots/04_catch_up.png)

### Usage paradox

![Usage paradox](screenshots/05_usage_paradox.png)

### Platform transformation and social value

![Platform transformation](screenshots/06_platform_transformation.png)

### Additional story detail

![Additional story detail](screenshots/07_story_detail.png)
